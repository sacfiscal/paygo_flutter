...
class UsuarioView extends StatefulWidget {
  final String title = 'UsuarioView';

  const UsuarioView({Key? key}) : super(key: key);

  @override
  UsuarioViewState createState() => UsuarioViewState();
}

class UsuarioViewState extends State<UsuarioView> with RouteAware {
                                      ...
                                      itemBuilder: (context, index) {
                                        return ListTile(
                                          ...
                                          title: Column(
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: Text(
                                                  controller.list.value[index].nome ?? '',
                                                  maxLines: 2,
                                                  style: TextStyle(
                                              ...
                                              Text(
                                                'Login do Usuário: ${controller.list.value[index].login ?? ''}',
                                                style: TextStyle(
                                          ...
                                          trailing: IconButton(
                                            ...
                                            onPressed: () async {
                                              controller.usuario.value = controller.list.value[index];
                                              Get.toNamed(NavigationRoutes.usuariosCadastro);
                                            },
                                          ),
                                        );
                                      },
                ...
                child: SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        controller.usuario.value = UsuarioModel(
