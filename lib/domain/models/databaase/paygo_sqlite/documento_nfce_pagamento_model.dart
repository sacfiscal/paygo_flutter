...
class DocumentoNfcePagamentoModel {
  int? id;
  int? emitenteId;
  int? documentoId;
  int? indPag;
  ...
  DocumentoNfcePagamentoModel copyWith({
    int? id,
    int? emitenteId,
    int? documentoId,
    int? indPag,
    ...
    return DocumentoNfcePagamentoModel(
      id: id ?? this.id,
      emitenteId: emitenteId ?? this.emitenteId,
      documentoId: documentoId ?? this.documentoId,
      indPag: indPag ?? this.indPag,
      tPag: tPag ?? this.tPag,
      vPag: vPag ?? this.vPag,
      descricaoPagamento: descricaoPagamento ?? this.descricaoPagamento,
      tpIntegra: tpIntegra ?? this.tpIntegra,
      cnpj: cnpj ?? this.cnpj,
      tBand: tBand ?? this.tBand,
      cAut: cAut ?? this.cAut,
      ...
      confirmationTransactionId: confirmationTransactionId ?? this.confirmationTransactionId,
      transactionNsu: transactionNsu ?? this.transactionNsu,
      ...
      defaultCardName: defaultCardName ?? this.defaultCardName,
      cardholderName: cardholderName ?? this.cardholderName,
      resultMessage: resultMessage ?? this.resultMessage,
      fullReceipt: fullReceipt ?? this.fullReceipt,
      merchantReceipt: merchantReceipt ?? this.merchantReceipt,
      cardholderReceipt: cardholderReceipt ?? this.cardholderReceipt,
      shortReceipt: shortReceipt ?? this.shortReceipt,
      graphicReceiptExists: graphicReceiptExists ?? this.graphicReceiptExists,
      merchantGraphicReceipt: merchantGraphicReceipt ?? this.merchantGraphicReceipt,
      cardholderGraphicReceipt: cardholderGraphicReceipt ?? this.cardholderGraphicReceipt,
  ...
  factory DocumentoNfcePagamentoModel.fromMap(Map<String, dynamic> map) {
    return DocumentoNfcePagamentoModel(
