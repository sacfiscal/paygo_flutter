...
class EmitenteModel {
  ...
  factory EmitenteModel.fromMap(Map<String, dynamic> map) {
    return EmitenteModel(
  ...
  factory EmitenteModel.fromJson(String source) => EmitenteModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'EmitenteModel(id: $id, razaoSocial: $razaoSocial, nomeFantasia: $nomeFantasia, cnpjCpf: $cnpjCpf, logradouro: $logradouro, numero: $numero, complemento: $complemento, bairro: $bairro, codigoMunicipio: $codigoMunicipio, municipio: $municipio, uf: $uf, cep: $cep, fone: $fone, ie: $ie, crt: $crt, idCsc: $idCsc, csc: $csc)';
  }

  @override
  bool operator ==(covariant EmitenteModel other) {
